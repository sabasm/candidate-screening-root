            ...
            <table className="min-w-full border border-gray-300 dark:border-gray-700">
              <thead>
                <tr className="bg-gray-100 dark:bg-gray-800">
                  <th className="py-2 px-4 border-b dark:border-gray-700 text-left">Rank</th>
                  <th className="py-2 px-4 border-b dark:border-gray-700 text-left">Name</th>
                  <th className="py-2 px-4 border-b dark:border-gray-700 text-left">Score</th>
                  <th className="py-2 px-4 border-b dark:border-gray-700 text-left">Highlights</th>
                </tr>
              </thead>
              <tbody>
                {results.map((candidate, index) => (
                  <tr key={candidate.id} className={index % 2 === 0 ? "bg-gray-50 dark:bg-gray-900" : "bg-white dark:bg-gray-800"}>
                    <td className="py-2 px-4 border-b dark:border-gray-700">{index + 1}</td>
                    <td className="py-2 px-4 border-b dark:border-gray-700">{candidate.name}</td>
